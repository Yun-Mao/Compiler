...
class Syntax:
    terminator = set()
    def __init__(self, log_level=2, sharp='#', point='.', acc='acc', productions_file='productions_测试First和Follow.txt'):
    ...
    def analyse(self, file):
        ...
        lexical = Lexical()
        # 载入源代码
        lexical.load(open('test2.c',encoding='UTF-8').read())
        # 执行词法分析
